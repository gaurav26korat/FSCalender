...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _lunarCalendar = [[NSCalendar alloc] initWithCalendarIdentifier:NSCalendarIdentifierIslamicCivil];
...
//        _lunarChars = @[@"初一",@"初二",@"初三",@"初四",@"初五",@"初六",@"初七",@"初八",@"初九",@"初十",@"十一",@"十二",@"十三",@"十四",@"十五",@"十六",@"十七",@"十八",@"十九",@"二十",@"二一",@"二二",@"二三",@"二四",@"二五",@"二六",@"二七",@"二八",@"二九",@"三十"];
        ...
        _lunarChars = @[@"SH 1",@"SH 2",@"SH 3",@"SH 4",@"SH 5",@"SH 6",@"SH 7",@"SH 8",@"SH 9",@"SH 10",@"SH 11",@"SH 12",@"SH 13",@"SH 14",@"SH 15",@"SH 16",@"SH 17",@"SH 18",@"SH 19",@"SH 20",@"SH 21",@"SH 22",@"SH 23",@"SH 24",@"SH 25",@"SH 26",@"SH 27",@"SH 28",@"SH 29",@"SH 30"];
    }
    return self;
}
